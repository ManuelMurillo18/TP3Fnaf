...
public class Patrol : BehaviorTree
{
    ...
    protected override void InitializeTree()
    {
        ...
        //************************************* Nodes *************************************//
        GoToTarget goTo1 = new GoToTarget(agent, animatronic, targets[0], 2, null, this);
        GoToTarget goTo2 = new GoToTarget(agent, animatronic, targets[1], 2, null, this);
        GoToTarget goTo3 = new GoToTarget(agent, animatronic, targets[2], 2, null, this);
        GoToTarget goTo4 = new GoToTarget(agent, animatronic, targets[3], 2, null, this);
        GoToTarget goTo5 = new GoToTarget(agent, animatronic, targets[4], 2, null, this);
        GoToTarget goTo6 = new GoToTarget(agent, animatronic, targets[5], 2, null, this);
        Wait wait2 = new Wait(2, null, this);
        Wait wait4 = new Wait(4, null, this);

        FollowPlayer followPlayer = new FollowPlayer(player, player.transform, agent, animatronic, 7f, 20, 4, null, this);
